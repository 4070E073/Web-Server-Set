<?php 
    ...
    if (isset($_POST['email'])) {
        ...
        if ($result->num_rows > 0){ // 是已註冊的 Email
            ...
            /* 寄信者的SMTP帳號 */
            $mail->Username =  "a0981835959@gmail.com"; // $cms_gmailname
            /* 寄信者的SMTP密碼 */
            $mail->Password = spmzpjhvqritonyw; // $cms_gmailpass 二段式驗證密碼（16字)

            /* 寄信者電子郵件 */
            $mail->From = "a0981835959@gmail.com";
            /* 寄信者名稱 */
            $mail->FromName = "Wei-Jie Ye";
            /* 收件者的電子郵件 */
            $mail->addAddress($email, "客倌");
            /* 回信的電子郵件 */
            $mail->addReplyTo("a0981835959@gmail.com", "Wei-Jie Ye");
            /* 信件主旨 */
            $mail->Subject = "重置密碼";
            /* 設定斷行字數 */
            // $mail->WordWrap = 50;
            ...
            'http://4070e073.com/ch12/reset_password.php?email=$email&token=$token'
            4070e073敬上");
            ...
            // 回應 AJAX 狀態代碼與訊息
            exit(json_encode(array("status" => 0, 
                "msg" => 'This email is not regiestered，請檢查您輸入的email！'))); 
        }
    }
?>
